...
| [Code](https://github.com/hummat/hummat.github.io/blob/master/notebooks/implicit-function-learning.ipynb) | [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/hummat/hummat.github.io/HEAD?labpath=notebooks%2Fimplicit-function-learning.ipynb) |
| :----------------------------: | :-----------------------------------------------------------------------------: |
