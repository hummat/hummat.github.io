...
To design an effective and efficient architecture, random search was used, as there was (and still isn't) a rich pool of provably effective network architectures available in the 3D domain.
