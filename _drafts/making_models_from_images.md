...
I'll start this article off with a brief motivation for this project. If you are not interested in this, just skip to the [second section](#2-structure-from-motion-and-multi-view-stereo).
